 ...
 * 
 * public Map<String, Object> consumerConfig(){ Map<String, Object> props = new
 * HashMap<>(); props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,
 ...
 * String>> containerFactory(ConsumerFactory<String, String> consumerFactory) {
