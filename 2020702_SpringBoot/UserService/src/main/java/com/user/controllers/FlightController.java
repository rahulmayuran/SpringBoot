...
import com.user.services.FlightService;
...
//
//	        // HttpEntity<tFlight> entity = new HttpEntity<Flight>(new Flight());
//	        HttpEntity<Flight> entity = null;
//	        ResponseEntity<List<Flight>> response =  restTemplate.exchange(
//	            "http://UserService/flight", 
//	            HttpMethod.GET, 
//	            entity, 
...
//		return flightservice.bookFlightById(flight);
//		
//	}
